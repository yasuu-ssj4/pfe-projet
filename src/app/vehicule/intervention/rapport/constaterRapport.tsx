...
import type { TraveauxExterne , TraveauxInterne } from "@/app/interfaces"
...
type Rapport = {
  rapport_complet: Rapport_Intervention
  TravauxExterne: TraveauxExterne[]
  TravauxInterne: TraveauxInterne[]
}
...
export default function ConstaterRapport({ id_demande_intervention }: ConstaterRapportProps){
  ...
  const createInternalRows = () => {
      ...
      for (let i = 6; i < internalWorks.length; i++) {
        ...
        rows.push(
          <tr key={`internal-extra-${i}`} className="border border-gray-800">
            <td className="border border-gray-800 p-1 text-xs">{item.description}</td>
    ...
    const createExternalRows = () => {
      ...
      if(data?.rapport_complet.structure_maintenance_en_charge_des_travaux) {
        const parts = data.rapport_complet.structure_maintenance_en_charge_des_travaux.split(',')
                ...
                <th className="border-2 border-gray-800  w-60">
                  ...
                  <div className="pt-2">
                    ...
                    <div className="text-center mt-1">
                      {data.rapport_complet.date_application 
                        ? new Date(data.rapport_complet.date_application).toLocaleDateString("fr-FR")
                        : "Non spécifié"}
                    </div>
                  </div>
                </th>
            ...
            <tbody>
              <tr>
                <td className="border-2 border-gray-800">
                  <div className="flex flex-col">
                    <div className="flex items-start">
                      ...
                      <span className="pl-1">{data.rapport_complet.id_rapport_intervention}</span>
                    </div>
                ...
                <td className="border-2 border-gray-800 p-1">
                  <div className="flex items-start">
                    ...
                    <span className="pl-1">{data.rapport_complet.numero_demande}</span>
                  </div>
                </td>
                <td className="border-2 border-gray-800 p-1 ">
              ...
              <tr>
                <td className="border-2 border-gray-800 px-1">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="pl-1">{new Date(formatDateToInputValue(data.rapport_complet.date_debut_travaux)).toLocaleDateString('fr-FR')}</span>
                    <span className="font-bold pl-1">à</span>
                    <span className="pl-1">{formatHeureToInputValue(data.rapport_complet.date_debut_travaux)}</span>
                  </div>
                </td>
                <td className="border-2 border-gray-800 px-1">
                  ...
                  <div className="flex items-center">
                    <span className="font-bold">Le</span>
                    <span className="pl-1">{new Date(formatDateToInputValue(data.rapport_complet.date_panne)).toLocaleDateString('fr-FR')}</span>
                    <span className="font-bold pl-1">à</span>
                    <span className="pl-1">{formatHeureToInputValue(data.rapport_complet.date_panne)}</span>
                  </div>
                </td>
                <td className="border-2 border-gray-800 p-1">
                  <div className="flex px-1">
                    <span className="font-bold">District / Autre:</span>
                    <span className="pl-1">{data.rapport_complet.district_id}</span>
                  </div>
                </td>
              </tr>
              <tr className="border-2 border-gray-800">
                <td className="border-2 border-gray-800">
                  ...
                  <span className="pl-2">{new Date(formatDateToInputValue(data.rapport_complet.date_fin_travaux)).toLocaleDateString('fr-FR')}</span>
                  <span className="font-bold px-1">à</span>
                  <span className="pl-2">{formatHeureToInputValue(data.rapport_complet.date_fin_travaux)}</span>
                </td>
                <td rowSpan={2}  className="border-2 border-gray-800">
                  <div className="font-bold  px-1">Date et heure de prise en</div>
                  <div className="font-bold px-1">charge des travaux :</div>
                  <span className="font-bold  px-1">Le</span>
                  <span className="pl-2">{new Date(formatDateToInputValue(data.rapport_complet.date_prise_charge)).toLocaleDateString('fr-FR')}</span>
                  <span className="font-bold  px-1">à</span>
                  <span className="px-1">{formatHeureToInputValue(data.rapport_complet.date_prise_charge)}</span>
                </td>
                <td rowSpan={2} className="border-2 border-gray-800 p-3">
                  <span className="font-bold mb-1 px-1">CDS/ Autre:</span>
                  <span className="pl-2">{data.rapport_complet.centre_id}</span>
                </td>
              </tr>
              <tr className="border-2 border-gray-800">
                <td className="border-2 border-gray-800">
                  <div className="font-bold mb-1 px-1">Durée des travaux :</div>
                  <span className="pl-2">{data.rapport_complet.duree_travaux}</span>
                </td>
              </tr>
            </tbody>
          </table>
            ...
            <table className="w-full border-collapse ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{data.rapport_complet.cout_total_traveaux_interne}</td>
                  <td className="bg-black"></td>
                </tr>
              </tbody>
            </table>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td className="border border-l-gray-800">{data.rapport_complet.cout_total_traveaux_externe}</td>
                </tr>
              </tbody>
            </table>
          </div>
              ...
              <tbody>
                <tr>
                  <td className="border border-gray-800 p-1 w-3/5">
                    ...
                    <span className="pl-1 min-h-[40px]">{data.rapport_complet.description_essais}</span>
                  </td>
                  <td className="border border-gray-800 p-1 w-2/5">
                    ...
                    <span className="flex gap-4 mt-1">
                      <span className="flex items-center">
                        <input
                          type="checkbox"
                          checked={data.rapport_complet.essais === "oui"}
                          readOnly
                      ...
                      <span className="flex items-center">
                        <input
                          type="checkbox"
                          checked={data.rapport_complet.essais === "non"}
                          readOnly
                          className="mr-1 h-3 w-3"
                        />
                        <span>Non</span>
                    ...
                    <div className="mt-2">
                      ...
                      <div className="pl-1 min-h-[20px]">{data.rapport_complet.reservation || ""}</div>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td className="border border-gray-800 p-1">
                    ...
                    <span className="pl-1">{data.rapport_complet.reference_documentée}</span>
                  </td>
                  <td className="border border-gray-800 p-1">
                    <div className="font-semibold">Date fin permis de travail :</div>
                    <div className="pl-1">{new Date (formatDateToInputValue(data.rapport_complet.date_fin_permis)).toLocaleDateString('fr-FR')}</div>
                  </td>
                </tr>
              </tbody>
            </table>
                ...
                <tr>
                  <td className="border-2 border-gray-800 p-3">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <span>{data.rapport_complet.nom_prenom_utilisateur}</span>
                      </div>
                      <div>
                        <span className=" text-sm font-medium mb-1">Date :</span>
                        <span className="px-3">
                          {data.rapport_complet.date_utilisateur
                            ? new Date(data.rapport_complet.date_utilisateur).toLocaleDateString("fr-FR")
                            : "Non spécifié"}
                        </span>
                      </div>
                      <div>
                  ...
                  <td className="border-2 border-gray-800 p-3">
                    ...
                    <div className="space-y-3">
                      <div>
                        <span className="text-sm font-medium mb-1">Nom et Prénom :</span>
                        <span>{data.rapport_complet.nom_prenom_responsable}</span>
                      </div>
                      <div>
                        <span className="text-sm font-medium mb-1">Date :</span>
                        <span>{new Date(data.rapport_complet.date_responsable).toLocaleDateString("fr-FR")}</span>
                      </div>
                      <div>
                        <span className="text-sm font-medium mb-1">Visa :</span>
                      </div>
                  ...
                  <td className="border-2 border-gray-800 p-3">
                    ...
                    <div className="space-y-3">
                      <div>
                        <span className="text-sm font-medium mb-1">Nom et Prénom :</span>
                        <span>{data.rapport_complet.nom_prenom_demandeur}</span>
                      </div>
                      <div>
                        <span className="text-sm font-medium mb-1">Date :</span>
                        <span>{new Date(data.rapport_complet.date_demandeur).toLocaleDateString('fr-FR')}</span>
                      </div>
                      <div>
