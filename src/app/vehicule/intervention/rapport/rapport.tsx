...
import type { RapportIntervention } from "../../../interfaces"

export default function FormRapport({ id_demande_intervention }: { id_demande_intervention: string }) {
  type infos = {
    ...
    <div>
      ...
      {Popup && (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black/50 z-50">
          <form onSubmit={handleSubmit} className="bg-[#f6f6f6] w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="">
                ...
                <thead>
                  <tr className="border-2 border-black">
                    ...
                    <th className="border-2 border-black">
                      ...
                      <label htmlFor="date_application" className="text-black">
                        Date application:
                      </label>
                      <br />
            ...
            <table className="border border-black">
              <thead>
                <tr className="border-2 border-black">
                  <th className="border-2 border-black">
                    <label htmlFor="id_rapport_intervention" className="mt-[2px]">
                      N° :
                    </label>
                    <input
            ...
            <table className="border border-black">
              <tbody>
                <tr className="border-2 border-black">
                  <td className="border-2 border-black">
                    <label htmlFor="description_essais">
                      Nature des Essais et/ou tests de fonctionnement realisées (Description sommaire) :{" "}
                    </label>
                    <br />
                    <input
                  ...
                  <td className="border-2 border-black">
                    ...
                    <div className="">
                      <label htmlFor="reservation" className="text-md font-medium">
                        Si non, Réserves :
                      </label>
                      <input
                        id="reservation"
