...
import { AlertCircle, ChevronLeft, ChevronRight, Loader2, Plus, RefreshCw, Search, X } from "lucide-react"
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto">
            ...
            {/* Add Marque Button */}
             ...
             {userPrivs.includes('ajouter_marque') &&(<button
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th
                scope="col"
                className="px-6 py-3 text-left  font-medium  text-bold uppercase tracking-wider"
              >
                ID
              </th>
              <th
            ...
            {isLoading ? (
              ...
              currentItems.map((marque) => (
                <tr key={marque.id_marque} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{marque.id_marque}</td>
