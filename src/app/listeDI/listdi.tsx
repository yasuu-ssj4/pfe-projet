...
export default function ListDIPage({ userId , userPrivs}: {userId: number, userPrivs: string[]}) {
              ...
              <tr>
                <td colSpan={8} className="px-6 py-12 text-center text-gray-500">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-lg font-medium text-red-500">Erreur lors du chargement des demandes d'intervention</p>
